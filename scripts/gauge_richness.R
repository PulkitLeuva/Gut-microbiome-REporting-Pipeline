...
# Your existing gauge plot function (same as before)
...
# Extract richness for the only sample
richness_value <- metrics$Richness[1]
sample_name <- metrics$Sample[1]

max_value <- 600  # Or set as you want based on your data

output_file <- glue(output_file)

create_semi_circular_gauge(
  value = richness_value,
  max_value = max_value,
  title = "Richness", 
